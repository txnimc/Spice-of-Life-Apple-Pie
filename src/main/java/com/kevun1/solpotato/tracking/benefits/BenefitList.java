...
public class BenefitList {
    ...
    public CompoundNBT serializeNBT() {
        ...
        tag.put("nthresholds", IntNBT.valueOf(nthresholds));
        int i = 0;

        for (List<Benefit> thresholdBenefits : benefits) {
            int nbenefits = thresholdBenefits.size();
            CompoundNBT thresholdTag = new CompoundNBT();
            thresholdTag.put("nbenefits", IntNBT.valueOf(nbenefits));
            int j = 0;
